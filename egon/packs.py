...
PACKS: dict[str, list[str]] = {
    ...
    "self-assessment-tools": [
        ...
        "PHQ-9 Monthly Depression Check-in",
        "GAD-7 Monthly Anxiety Check-in",
        "Rosenberg Self-Esteem Scale Check-in",
        "PSS-10 Monthly Stress Check-in",
        "WHO-5 Wellbeing Check-in",
        "Brief Resilience Scale Check-in",
